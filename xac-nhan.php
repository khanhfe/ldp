            ...
            <div class="main-container">
                <div class="main__header__left">
                    ...
                    <div class="main__header__meta status ">
                        Trạng thái: <span class="value success">Thu tiền</span>
                    </div>
                </div>
                <div class="main__header__flex-button pd-r30 mb-12">
                    <button type="button" class="btn btn-primary w-100">Xác nhận đã nhận tiền</button>
                </div>
            </div>
        </div>
        ...
        <div class="main-table table-2">
            <div class="main-container">
                ...
                <div class="main-table__row">
                    ...
                    <div class="main-table__column light">Thu thanh lý, nhượng bán tài sản</div>
                </div>
                <div class="main-table__row">
                    <div class="main-table__column flex-150">Khoản mục con:</div>
                    <div class="main-table__column light">Thanh lý tài sản cố định</div>
                </div>
                <div class="main-table__row">
